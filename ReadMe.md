...
useRouteMatch is useful anytime you are useing a {Route} it finds and gives access to matching data
2. How would you explain form validation to someone who has never programmed before?
form validation is a way of controlling information being submitted in inputs on a page, something like
makeing sure the email is an email or the password has a minimum number of characters or that the username
doesn't have any spaces.
3. In 1-2 sentences, define end to end testing.
end to end testing is testing the app or software from beginning to end and makes sure that the app's behavior is as expected. End to end testing code simulates a user using your app and looks for expected behavior when forms are filled out to buttons being clicked.
